...
let lucas: Pessoa = new Pessoa('Lucas', 28, 950);
let joao: Pessoa = new Pessoa('Joao', 45, 800);
let ana: Pessoa = new Pessoa('Ana', 13, 1070);
let lucia: Pessoa = new Pessoa('Lucia', 32, 2350);
let rosa: Pessoa = new Pessoa('Rosa', 23, 2000);
